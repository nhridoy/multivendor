...
from chat.utility_functions.database_operations import get_chat_session, store_chat_message, get_chat_session_history
...
class AsyncWebConsumer(AsyncJsonWebsocketConsumer):
    ...
    async def receive_json(self, content, **kwargs):
        chat_log = await store_chat_message(self.group_name, self.scope['user'], content['message'])
        response = {
            "id": chat_log.id,
